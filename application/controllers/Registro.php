...
class Registro extends CI_Controller
{
    ...
    {
        /* Si el captcha esta halitado */
        if($this->config->item('active')){

            /* Si el captcha NO coincide */
            ...
            /* Si el captcha SI coincide */    
                ...
                /* Si existe coincidencia en Base de Datos*/
                if($last == 1){
                ...
                /* Si NO existe coincidencia en Base de Datos*/
                }else{
                    $data['cabecera'] = $this->load->view('adminlte/linksHead', '', true);
                    $data['footer']   = $this->load->view('adminlte/scriptsFooter', '', true);
                    $data['captcha'] = $this->generarCaptcha();
        ...
        /* Si el captcha NO esta halitado */
        }else{
            //Hola mundo
            $id_usuario_dni = $this->input->post('id');//el id por defecto sera el dni pero puede ser cambiado  cualquier otro
