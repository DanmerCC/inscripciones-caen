...
class Inscripcion_model extends CI_Model
{
	...
	*/
	public function get_page($start,$limit = 10){
		$this->db->select('CONCAT(c.numeracion," ",c.nombre) as curso_numeracion,ins.id_inscripcion,c.id_curso,c.nombre as nombre_curso,c.numeracion,a.nombres as nombres,a.apellido_paterno,a.apellido_materno,u.acceso as nombre_user,ins.created as created ,ins.id_inscripcion');
	...
	public function get_page_and_filter($start,$limit,$text){
		$this->db->select('ins.id_inscripcion,c.id_curso,c.nombre as nombre_curso,c.numeracion,a.nombres as nombres,a.apellido_paterno,a.apellido_materno,u.acceso as nombre_user,ins.created as created');
		$this->db->from($this->table.' ins');
		$this->db->like('CONCAT(c.numeracion," ",c.nombre)',$text);
