...
class Solicitud_model extends CI_Model
{
  ...
  //           $result[$i]=$row;
	...
	public function getAll(){
		$result=$this->db->query("SELECT s.idSolicitud,s.estado estado,s.programa,s.alumno,s.tipo_financiamiento,s.fecha_registro,a.documento,a.nombres,a.apellido_paterno,a.apellido_materno,c.nombre curso_nombre,c.numeracion curso_numeracion ,s.marcaPago , s.comentario FROM solicitud s left join alumno a on s.alumno=a.id_alumno left join curso c on s.programa=c.id_curso");
		return $result;
	}
