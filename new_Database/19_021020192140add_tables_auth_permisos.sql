CREATE TABLE `caenedup_caen2`.`auth_rol` ( `id` INT NOT NULL AUTO_INCREMENT ,
       `nombre` VARCHAR(100) NOT NULL ,
       PRIMARY KEY (`id`)) ENGINE = InnoDB;

CREATE TABLE `caenedup_caen2`.`auth_permisos` ( `id` INT NOT NULL AUTO_INCREMENT ,
       `nombre` VARCHAR(100) NOT NULL ,
       PRIMARY KEY (`id`)) ENGINE = InnoDB;

CREATE TABLE `caenedup_caen2`.`auth_roles_permisos` ( `id` INT NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE `caenedup_caen2`.`auth_roles_users` ( `id` INT NOT NULL AUTO_INCREMENT ,
       `auth_roles_id` INT NOT NULL ,
